              ...
              <div className="flex flex-col gap-3 sm:flex-row">
                <div className="flex-1">
                  <Input
                    ...
                    className="h-11 sm:h-12 rounded-2xl border-gray-200 focus:border-[#F59E0B] focus:ring-[#F59E0B] transition-all text-sm sm:text-base"
                    onKeyPress={(e) =>
                ...
                <Button
                  ...
                  className="h-12 px-6 text-white rounded-2xl"
                  style={{
                    background:
                      "linear-gradient(135deg, #F59E0B 0%, #FBBF24 100%)",
                  }}
