  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        <div className="absolute bottom-1/3 right-1/3 w-40 h-40 bg-cyan-200 rounded-full opacity-10 blur-3xl animate-pulse" style={{ animationDelay: '1s' }} />
      </div>
        ...
        <CardHeader className="space-y-4 text-center pt-8 pb-6 relative">
          ...
          <div className="mx-auto relative">
            <div 
              ...
              style={{ background: 'linear-gradient(135deg, #10B981 0%, #00AEEF 100%)' }}
            >
              <Shield className="text-white" size={36} />
              <Sparkles className="absolute -top-1 -right-1 text-yellow-300 opacity-80" size={20} />
              <Star className="absolute -bottom-1 -left-1 text-cyan-300 opacity-60" size={16} fill="currentColor" />
            </div>
            ...
            <div className="absolute -bottom-2 -left-2 w-4 h-4 rounded-full bg-green-200 opacity-60 animate-pulse" style={{ animationDelay: '0.5s' }} />
          </div>
        ...
        <CardContent className="space-y-6 px-8 pb-8">
          ...
          <div className="text-center space-y-3">
            ...
            <button
              ...
              className="text-sm font-medium text-[#00AEEF] hover:text-[#1A4D8F] transition-colors underline"
            >
              Resend OTP Code
            </button>
          </div>
          ...
          <button
            onClick={onBack}
            className="flex items-center justify-center gap-2 text-sm text-gray-600 hover:text-[#00AEEF] w-full transition-colors group"
          >
