      ...
      <Card className="w-full max-w-md shadow-2xl border-0 relative z-10 rounded-3xl overflow-hidden">
        ...
        <CardHeader className="space-y-4 text-center pt-8 pb-6 relative">
          ...
          <div className="mx-auto relative">
            ...
            <div className="absolute -bottom-2 -left-2 w-4 h-4 rounded-full bg-purple-200 opacity-60 animate-pulse" style={{ animationDelay: '0.5s' }} />
          </div>
        ...
        <CardContent className="space-y-6 px-8 pb-8">
          ...
          <button
            onClick={onBack}
            className="flex items-center justify-center gap-2 text-sm text-gray-600 hover:text-purple-600 w-full transition-colors group"
          >
