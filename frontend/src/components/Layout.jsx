...
export default function Layout() {
  ...
  const menuItems = [
    { path: '/dashboard', label: 'Dashboard', icon: LayoutDashboard, roles: ['teller', 'accountant'] },
    { path: '/savings/open', label: 'Open Account', icon: UserPlus, roles: ['teller'] },
    { path: '/savings/deposit', label: 'Deposit', icon: ArrowDownToLine, roles: ['teller'] },
    { path: '/savings/withdraw', label: 'Withdraw', icon: ArrowUpFromLine, roles: ['teller'] },
    { path: '/search', label: 'Search', icon: Search, roles: ['teller', 'accountant'] },
    { path: '/reports/daily', label: 'Daily Report', icon: FileText, roles: ['accountant'] },
    { path: '/reports/monthly', label: 'Monthly Report', icon: FileText, roles: ['accountant'] },
          ...
          <div className="flex items-center justify-between">
            ...
            >
              ...
              >
                ...
                <Sparkles className="absolute opacity-50 -top-1 -right-1 text-cyan-300 animate-pulse" size={16} />
              </div>
              {(!isSidebarCollapsed || isMobile) && (
                <div className="overflow-hidden transition-all duration-300" style={{
                  ...
                  <h1 className="text-xl font-semibold tracking-tight text-white whitespace-nowrap">KASA</h1>
            ...
            <div className="flex items-center min-w-0 gap-3">
              ...
              >
                ...
                <div className="hidden sm:block">
                  <div className="text-lg font-bold tracking-tight text-white">KASA</div>
