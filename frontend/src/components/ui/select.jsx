...
function SelectTrigger({ className, size = "default", children, ...props }) {
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      className={cn(
        "flex items-center justify-between w-full h-11 sm:h-12 px-4 rounded-2xl border border-gray-200 bg-input-background text-sm sm:text-base",
  ...
  return (
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        className={cn(
          "bg-white text-popover-foreground rounded-2xl border border-gray-100 shadow-lg p-1.5",
...
function SelectItem({ className, children, ...props }) {
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        "relative flex w-full cursor-pointer items-center gap-2 rounded-lg px-4 py-2 text-sm sm:text-base",
